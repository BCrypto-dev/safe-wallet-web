...
export const GATEWAY_URL_PRODUCTION =
  process.env.NEXT_PUBLIC_GATEWAY_URL_PRODUCTION || 'https://gateway.devsafe.bit-rock.io/'
export const GATEWAY_URL_STAGING = process.env.NEXT_PUBLIC_GATEWAY_URL_STAGING || 'https://gateway.devsafe.bit-rock.io/'
...
// Social
export const DISCORD_URL = 'https://discord.gg/xUTRESq8Xq'
export const TWITTER_URL = 'https://twitter.com/BitRockChain'
